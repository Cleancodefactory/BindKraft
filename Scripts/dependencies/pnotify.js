            ...
            $.each(body_data, function () {
                ...
                if (this.css("display") != "none") {
                    ...
                    if ((s.dir1 == "down" && s.nextpos1 + this.height() > jwindow.height()) ||
						...
						(s.dir1 == "right" && s.nextpos1 + 700 + this.width() > jwindow.width())) {
                ...
                if (opts.pnotify_history) {
                    ...
                    if (typeof body_history == "undefined") {
                        body_history = $("<div />", {
                            ...
                            "mouseleave": function () {
                                body_history.hide();
                                // body_history.animate({ bottom: "-" + 75 + "px", right: 5 + "px" }, { duration: 100, queue: false });
                            }
                        })
					...
					.append($("<button />", {
					    ...
					    "click": function () {
					        $('#msg_counter').text(counter);
					        var oldCounter = $('#msg_counter').text();
					        var newCounter = oldCounter - 1;
					        if (oldCounter == 0) {
					            $('#msg_counter').text(oldCounter);
					        }
					        else {
					            $('#msg_counter').text(newCounter);
                             }
					...
					.appendTo(body);
                        ...
                        //                                "mouseenter": function () {
                        //body_history.animate({ bottom: "-75" }, { duration: 100, queue: false });
                        //                                }
                        //                            })
                        ...
                        //                            history_handle_bottom = handle.offset().bottom + 2;
                        //                            // Hide the history pull down up to the top of the handle.
                        //                            body_history.css({ bottom: 35 + "px", right: 5 + "px" });
