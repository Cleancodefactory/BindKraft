/**
	...
	Configuration: {order fields array} [["fieldname","dirfield"],....]
	
	Both are field names
*/
function TranslateOrdersArrayToParameters(conf) {
	BaseObject.apply(this, arguments);
	this.conf = conf;
}
TranslateOrdersArrayToParameters.Inherit(BaseObject, "TranslateOrdersArrayToParameters");
TranslateOrdersArrayToParameters.Implement(ITranslateParamersToOrdersArray);
TranslateOrdersArrayToParameters.prototype.configureOrderParameters = function(conf) { 
	this.conf = conf;
}

TranslateOrdersArrayToParameters.prototype.PerformTranslation = function(/*orders array*/ ordarray) {
