...
// Service provider query. The consumer obtains a reference to an object supporting the requested service. Usually (the standard implementations) this is the closest parent that
...
// if they are the best service provider for the reason specified. When handling use simple comparison == or check carefully for the reason's type before performing something more specific.
/*CLASS*/ /*QUERY*/
