...
var JBFrameworkVersion = { 
	core: { major: 2, minor: 21, revision: 5 }
};
...
(function() {
	...
	var defaults = {
		...
		TrackingDefaultMode: "mouse", // Sets the PointerTracker to simulate capture with mouse or pointer messages (or touch ad hoc implementation in future)
