...
var ProxyStubBuildingRoutines = {
	...
	refMethod: function(key) {
		return new Function('if (this.__obliterated) this.$instance = null;\
							if (this.$instance != null && this.$instance.__obliterated) { this.$instance = null; }\
	...
	buildProxyClass: function(_baseProxyDef, classDef, ifaceDef, _methodBody) {
		...
		if (cls == null) {
			...
			'$Managed_BaseProxy.call(this,instance,transport,builder,container); return this.$initializeProxy();');
