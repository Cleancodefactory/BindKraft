...
////////////////////////// WhiteSpaceValidatorControl ///////////////////////////////////////////
function WhiteSpaceValidatorControl(v) {
    ValidateValue.apply(this, arguments);
}

WhiteSpaceValidatorControl.Inherit(ValidateValue, "WhiteSpaceValidatorControl");
WhiteSpaceValidatorControl.registerValidator("whitespace");

WhiteSpaceValidatorControl.prototype.get_message = function (lastValue) {
    var msg = this.get_text();
    if (msg == null || msg.length == 0) {
        msg = Binding.resources.get("Validation.Spaces");
    }
    if (msg == null || msg.length == 0) {
        msg = "Only white spaces is not allowed!!!";
    }
    return msg;
};

WhiteSpaceValidatorControl.prototype.validateValue = function (validator, value, binding) {
