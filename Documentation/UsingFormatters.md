...
There are two instance methods defined in BaseObject providing options to call formatters directly - both system and custom ones. Because of the way the custom formatters are used the 
